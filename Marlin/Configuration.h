...
#define STRING_CONFIG_H_AUTHOR "Maxime Lajoie" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 V2 CUSTOM SKR"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.95,  22.95 }
    #define DEFAULT_Ki_LIST {   1.95,   1.95 }
    #define DEFAULT_Kd_LIST {  67.48,  67.48 }
  #else
    #define DEFAULT_Kp  22.95
    #define DEFAULT_Ki   1.95
    #define DEFAULT_Kd  67.48
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 103.94
  #define DEFAULT_bedKi  20.30
  #define DEFAULT_bedKd 354.79
